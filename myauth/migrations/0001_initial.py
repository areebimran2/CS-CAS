...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'db_table': 'users',
                'constraints': [models.UniqueConstraint(fields=('phone',), name='users_phone_key'), models.UniqueConstraint(fields=('email',), name='users_email_key'), models.CheckConstraint(condition=models.Q(('twofa_method__in', ['sms', 'totp'])), name='users_twofa_method_check')],
            },
            managers=[
