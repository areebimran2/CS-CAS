# Generated by Django 5.2.9 on 2025-12-04 14:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_superuser', models.BooleanField(db_default=False, default=False, help_text='Designates that this user has all permissions without explicitly assigning them.', verbose_name='superuser status')),
                ('is_staff', models.BooleanField(db_default=False, default=False, help_text='Designates whether the user can log into this admin site.', verbose_name='staff status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('perm_key', models.ForeignKey(db_column='perm_key', db_index=False, on_delete=django.db.models.deletion.CASCADE, to='myauth.permission')),
                ('role', models.ForeignKey(db_index=False, on_delete=django.db.models.deletion.CASCADE, to='myauth.role')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='role',
            name='permissions',
            field=models.ManyToManyField(related_name='roles', through='myauth.RolePermission', to='myauth.permission'),
        ),
        migrations.CreateModel(
            name='UserRole',
            fields=[
        ...
        migrations.AddField(
            model_name='user',
            name='roles',
            field=models.ManyToManyField(related_name='users', through='myauth.UserRole', to='myauth.role'),
        ),
        migrations.CreateModel(
            name='UserPreference',
            fields=[
                ...
                ('opt_in_enabled', models.BooleanField(db_default=False)),
                ('notify_cabin_avail', models.BooleanField(db_default=True)),
                ('notify_flash_sale', models.BooleanField(db_default=True)),
                ('notify_release_request', models.BooleanField(db_default=True)),
            ],
            options={
                'db_table': 'user_prefs',
                'constraints': [models.CheckConstraint(condition=models.Q(('fx_mode__in', ['manual', 'live'])), name='user_prefs_fx_mode_check')],
            },
        ),
        ...
        pgtrigger.migrations.AddTrigger(
            model_name='role',
            trigger=pgtrigger.compiler.Trigger(name='trg_roles_updated', sql=pgtrigger.compiler.UpsertTriggerSql(func='\n            BEGIN\n                NEW.updated_at := NOW();\n                RETURN NEW;\n            END;\n            ', hash='4f0275eb4a47489a245bb9471c61877b23910573', operation='UPDATE', pgid='pgtrigger_trg_roles_updated_eb99b', table='roles', when='BEFORE')),
        ),
        migrations.AddConstraint(
            model_name='user',
